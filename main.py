...
def scrape_real_estate_prices(url):
    ...
    for property_info in soup.find_all('div', class_='property-info'):
        ...
        property_dict['Bedrooms'] = property_info.find('div', class_='bedrooms').text.strip()
        property_dict['Bathrooms'] = property_info.find('div', class_='bathrooms').text.strip()
        property_dict['Area_Sqft'] = property_info.find('div', class_='area').text.strip()
...
if __name__ == '__main__':
    ...
    property_list = scrape_real_estate_prices('https://www.example.com/real_estate')
